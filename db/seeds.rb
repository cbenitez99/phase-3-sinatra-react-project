...
game1 = Game.create(title: "FIFA 2021", price: 59, platform: "Xbox One")
game2 = Game.create(title: "Call of Duty: Thor's Wrath", price: 39, platform: "PlayStation5")
game3 = Game.create(title: "The Legend of Zelda: Breath of The Wild", price: 49, platform: "Nintendo Switch")
